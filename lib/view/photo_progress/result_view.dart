...
class _ResultViewState extends State<ResultView> {
                  ...
                  AnimatedContainer(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                          gradient: LinearGradient(colors: TColor.primaryG), borderRadius: BorderRadius.circular(30)),
                    ),
                  ),
                  SizedBox(
                    height: 40,
                      ...
                      children: [
                        SimpleAnimationProgressBar(
                          ...
                          gradientColor: LinearGradient(
                              colors: TColor.primaryG, begin: Alignment.centerLeft, end: Alignment.centerRight),
                        ),
                        Text(
                          "62%",
                          style: TextStyle(
  ...
  LineChartBarData get lineChartBarData1_2 => LineChartBarData(
        isCurved: true,
        gradient:
            LinearGradient(colors: [TColor.secondaryColor2.withOpacity(0.5), TColor.secondaryColor1.withOpacity(0.5)]),
        barWidth: 2,
        isStrokeCapRound: true,
        dotData: FlDotData(show: false),
