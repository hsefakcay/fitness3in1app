...
import 'package:fitness_ai_app/common_widget/icon_title_next_row.dart';
import 'package:fitness_ai_app/common_widget/round_button.dart';
import 'package:fitness_ai_app/view/workout_tracker/exercises_stpe_details.dart';
import 'package:fitness_ai_app/view/workout_tracker/workout_schedule_view.dart';
                  ...
                  child: Column(
                    children: [
                      ...
                      Container(
                        ...
                        height: 4,
                        decoration:
                            BoxDecoration(color: TColor.gray.withOpacity(0.3), borderRadius: BorderRadius.circular(3)),
                      ),
                      SizedBox(
